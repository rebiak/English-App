...
🪑 | The pencil is under the table. | El lápiz está debajo de la mesa.
...
💬 | Is that your answer? | ¿Es esa tu respuesta?
...
💬 | Is this your answer? | ¿Es ésta tu respuesta?
...
🚫 | Your name's not on this list. | Tu nombre no está en esta lista.
❓ | Where is it then?. | ¿Dónde está entonces?
...
❓ | What's your name? | ¿Cuál es tu nombre?
❓ | What's his name? | ¿Cuál es su nombre? (de él)
❓ | What's my last name / surname? | ¿Cuál es mi apellido?
...
❓ | Is that your final decision? | ¿Es ésa tu decisión final?
...
🧒 | Your answers are right / correct. | Tus respuestas son correctas.
...
📌 | They're next to us. | Ellas están al lado de nosotros.
🔓 | The windows are open. | Las ventanas están abiertas.
🧒 | The days are long now. | Los días son largos ahora.
...
📌 | She's next to him. | Ella está al lado de él.
...
✉️ | Whose envelope is this? | ¿De quién es este sobre?
❓ | Where are they? | ¿Dónde están?
❓ | Where is it? | ¿Dónde está?
❓ | What's this? | ¿Qué es esto?
🧒 | What are these? | ¿Qué son estos?
...
📌 | Mine is next to hers. | El mío está al lado del de ella.
❓ | Where are ours? | ¿Dónde están los nuestros?
...
🏙️ | It's a very beautiful city. | Es una ciudad muy hermosa.
...
🪑 | They're under the desk. | Están debajo del escritorio.
...
💬 | Is this the answer? | ¿Es ésta la respuesta?
...
1️⃣ | That one's mine. | Aquél es mio.
🧒 | These are yours. | Estos son tuyos.
1️⃣ | This one's pretty. | Este es bonito.
1️⃣ | That one's ugly. | Ese es feo.
1️⃣ | This one's for them. | Este es para ellos.
...
1️⃣ | Which one's yours, this one or that one? | ¿Cuál es el tuyo, éste o aquél?
1️⃣ | The one over there is his. | La que está allí es de él.
...
1️⃣ | The one here is mine. | El que está aquí es mío.
...
1️⃣ | Is this (one) hers? | ¿Es éste el de ella?
...
1️⃣ | This isn't the only one. | Este no es el único.
📌 | Mine are next to his. | Los míos están al lado de los de él.
...
🧒 | His answers are right / correct. | Sus respuestas son correctas (de él)
...
🥶 | It's always cold in this room. | Siempre hace frió en ese cuarto.
⛅ | How's the weather today? | ¿Qué tiempo hace hoy?
"""
...
💬 | What's their answer? | ¿Cuál es su respuesta? (de ellos)
...
🧒 | Why are John's eyes green? | ¿Por qué son verdes los ojos de Juan?
🚫 | They're not ready yet. | No están listos todavía.
✅ | I'm fine, thank you. | Estoy bien, gracias.
"""

    private const val list11 = """
1️⃣ | That one's mine. | Aquél es el mío.
❓ | Is it yours? | ¿Es tuyo?
❓ | Where are ours? | ¿Dónde están los nuestros?
✨ | Is it new? | ¿Es nuevo?
...
🌙 | It's dark. | Está oscuro.
❓ | Who is it? | ¿Quién es?
🧒 | Those pens are ours. | Aquellos bolígrafos son nuestros.
1️⃣ | This one is Pepe's. | Este es el de Pepe.
...
🧒 | Whose letters are these? | ¿De quién son estas cartas?
...
1️⃣ | Yours is that one, isn't it? | El tuyo es aquél, ¿no?
...
1️⃣ | If this one is theirs, then that one's ours. | Si éste es de ellos, entonces ése es nuestro.
...
❓ | Her name's Mary, isn't it? | Se llama María, ¿no?
...
⚖️ | Where's the lawyer's money? | ¿Dónde está el dinero del abogado?
...
♾️ | Why is it always difficult? | ¿Por qué es difícil siempre?
...
1️⃣ | Theirs is the one over there. | El de ellos es el que está allí.
...
1️⃣ | What's the next one? | ¿Cuál es el siguiente?
1️⃣ | Which one's mine, this one or that one? | ¿Cuál es el mío, éste o aquél?
...
👥 | At least people are in the waiting room. | Al menos personas están en la sala de espera.
...
1️⃣ | There's a potato in the oven. | Hay una patata en el horno.
🛫 | There's an airport near here. | Hay un aeropuerto cerca de aquí.
...
1️⃣ | Is there a special way? | ¿Hay una forma especial?
1️⃣ | There's only one way: mine. | Hay solamente una forma: la mía.
1️⃣ | Why is there only one way? | ¿Por qué hay sólo una forma?
...
1️⃣ | There's a reason for everything. | Hay una razón para todo.
...
⚡ | Is it necessary now? | ¿Es necesario ahora?
1️⃣ | There's only one possibility. | Hay sólo una posibilidad.
...
1️⃣ | There's a pretty long line /queue. | Hay una cola bastante larga.
...
1️⃣ | There's one here. | Hay uno aquí.
1️⃣ | There's another one over there. | Hay otro allí.
1️⃣ | This one's mine and the other one's his. | Este es mío y el otro es de él.
...
1️⃣ | There's only one way: mine. | Sólo hay una manera: la mía.
...
⚡ | Start right now. | Empiece ahora mismo.
🎁 | Give me a chance. | Dame una oportunidad.
📌 | Show me your card. | Enséñame tu carné.
🍽️ | Eat it with your hands. | Cómelo con las manos.
...
🗣️ | Speak slowly when you're with me. | Habla despacio cuando estés conmigo.
...
🛫 | Take me to the airport. | Lléveme al aeropuerto.
...
✂️ | Cut it as short as possible. | Córtalo lo más corto posible.
...
🧂 | Leave the room where you are. | Sal de la habitación donde estás.
...
💬 | Say only your first name. | Di sólo tu nombre de pila.
...
😴 | Don't sleep on soft beds. | No duermas en camas blandas.
...
1️⃣ | Use this one, not that one. | Utilice éste, no aquél.
...
⚡ | She's bringing it to me right now. | Ella me lo está trayendo ahora mismo.
❓ | Are they looking at me? | ¿Están mirándome?
✍️ | Why are they writing that? | ¿Por qué están escribiendo eso?
1️⃣ | I'm recording a tape. | Estoy grabando una cinta.
...
🗣️ | Who's she talking to? | ¿Con quién está ella hablando?
...
1️⃣ | I'm making a very long list. | Estoy haciendo una lista muy larga
"""
...
⚡ | They're waking them up now. | Están despertándoles ahora.
...
⚡ | They're leaving now. | Están marchándose ahora.
📌 | She's losing her voice. | Ella está perdiendo su voz.
🥱 | I'm getting tired of this. | Me estoy cansando de esto.
⚡ | They're getting married now. | Se están casando ahora.
...
🗣️ | Who are you talking to? | ¿Con quién estás hablando?
...
🧠 | How do you know it belongs to you? | ¿Cómo sabes que te pertenece?
...
🗓️ | How much does he earn a month? | ¿Cuánto gana al mes?
...
1️⃣ | No one lives here. | Nadie vive aquí.
...
🏷️ | How much does it cost? | ¿Cuánto cuesta?
...
🧠 | Does she know you're married? | ¿Sabe (ella) que estás casado?
...
💬 | Do you have to answer them? | ¿Tienes que contestarlas?
...
🧠 | Does he know how to spell correctly? | ¿Sabe él deletrear correctamente?
🧠 | They know everything about us. | Saben todo acerca de nosotros.
...
♾️ | I always make an effort. | Siempre hago un esfuerzo.
...
💬 | What do you mean? | ¿Qué quieres decir?
💬 | You know what I mean. | Tú sabes lo que quiero decir.
🔨 | Why are you going to do that? | ¿Por qué vas a hacer eso?
📌 | Because I do what I want. | Porque hago lo que quiero.
🧠 | Do you know what you're saying? | ¿Sabes lo que estás diciendo?
...
🧠 | Enough to know a lot of things. | Los suficientes como para saber muchas cosas.
...
📌 | It's the only language he speaks. | Es la única lengua que habla.
🧠 | Do you know him well? | ¿Le conoces bien?
...
⚡ | I speak to him like I'm speaking to you now. | Le hablo como te hablo a ti ahora.
...
🧠 | I know a little, but not enough. | Sé un poco, pero no lo suficiente.
...
🧠 | Because you don't know what you're missing. | Porque no sabes lo que estás perdiendo.
📌 | Teach me the language. | Enséñame el idioma.
...
🧠 | Does she know you want to marry her? | ¿Sabe que quieres casarte con ella?
...
📌 | He knows more than you think | Él sabe más de lo que tú crees.
⭕ | Nobody knows more than I do. | Nadie sabe más que yo.
"""

    private const val list29 = """
🧠 | I know there's a way to do it. | Sé que hay una manera de hacerlo.
...
⚡ | I'm going to call him right now. | Le voy a llamar ahora mismo.
...
🧠 | Does Morgan know anything? | ¿Sabe Morgan algo?
...
1️⃣ | That's the one that breaks easily. | Ese es el que se rompe fácilmente.
...
♾️ | I always have to clean the floor. | Siempre tengo que limpiar el suelo.
...
🧠 | I know he studies very little. | Sé que él estudia muy poco.
...
❓ | He knows you, doesn't he? | Él te conoce, ¿no?
