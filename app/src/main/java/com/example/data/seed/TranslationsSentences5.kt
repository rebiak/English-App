...
"""
            2 -> """
💵 | If we had more money, we would go on vacation | Si tuviéramos más dinero, nos iríamos de vacaciones
...
"""
            3 -> """
🇪🇸 | She told me that she was moving to Spain | Me dijo que se mudaba a España
...
🛣️ | He warned us that the road was dangerous | Nos advirtió que la carretera era peligrosa
🗣️ | I explained that I didn't know the answer | Expliqué que no sabía la respuesta
...
🛣️ | The road is being repaired right now | La carretera está siendo reparada ahora mismo
📦 | All orders are shipped within twenty-four hours | Todos los pedidos se envían en 24 horas
🏛️ | The museum is closed on Mondays | El museo está cerrado los lunes
...
🥶 | It may get colder later tonight | Puede que haga más frío más tarde esta noche
...
🛏️ | Don't put off cleaning your room | No pospongas limpiar tu habitación
...
🌧️ | They called off the match due to rain | Cancelaron el partido debido a la lluvia
🛏️ | Turn off the lights when leaving the room | Apaga las luces al salir de la habitación
...
"""
            10 -> """
📅 | It's twenty-five degrees Celsius today | Hace veinticinco grados centígrados hoy
...
"""
            11 -> """
🧑‍⚕️ | I need to schedule a health checkup | Necesito programar un chequeo médico
...
🧑‍⚕️ | The doctor listened to my heart rate | El médico escuchó mi ritmo cardíaco
...
🧥 | I'm looking for a warm winter jacket | Estoy buscando una chaqueta de invierno abrigada
...
📰 | Practice your speaking skills daily | Practica tus habilidades orales a diario
🗣️ | Learning a new language takes patience | Aprender un idioma nuevo requiere paciencia
...
🚆 | We saw our guests off at the train station | Despedimos a nuestros invitados en la estación de tren
"""
            21 -> """
🍞 | That test was a piece of cake | Ese examen fue pan comido
🐕 | It's raining cats and dogs right now | Está lloviendo a cántaros ahora mismo
...
👁️ | Maintain pleasant eye contact during conversations | Mantén un contacto visual agradable durante las conversaciones
