...
object TranslationsSentencesA {
    ...
    private fun getListData(index: Int): String {
        return when (index) {
            1 -> """
🛏️ | What have you been discussing in the conference room? | ¿Qué habéis estado debatiendo en la sala de conferencias?
...
✈️ | He has just landed after a transcontinental flight | Acaba de aterrizar tras un vuelo transcontinental
...
🥤 | Where would you establish headquarters if given the choice? | ¿Dónde establecerías la sede si pudieras elegir?
...
"""
            3 -> """
😢 | The ambassador remarked that bilateral relations were stable | El embajador señaló que las relaciones bilaterales eran estables
...
🌙 | Severe gales may disrupt maritime transport tonight | Fuertes vendavales podrían alterar el transporte marítimo esta noche
...
↔️ | He engages in interval training along the riverside promenade | Realiza entrenamiento a intervalos por el paseo fluvial
...
💧 | Persistent precipitation replenished regional water reservoirs | Las precipitaciones persistentes reabastecieron los embalses regionales
...
🌙 | Alpine passes received substantial snowfall overnight | Los puertos alpinos recibieron importantes nevadas durante la noche
...
↔️ | Courier transport includes tracked international delivery | El transporte por mensajería incluye entrega internacional con seguimiento
...
🐕 | It is raining cats and dogs throughout the entire mountain basin | Está lloviendo a cántaros en toda la cuenca montañosa
👁️ | Advanced cryogenic apparatus costs an arm and a leg | El instrumental criogénico avanzado cuesta un ojo de la cara
...
🧑‍⚕️ | The groundbreaking medical discovery occurred out of the blue | El revolucionario descubrimiento médico se produjo de la nada
"""
            22 -> """
...
✉️ | Constitutional charters codified immutable human liberties | Las cartas constitucionales codificaron libertades humanas inmutables
...
👁️ | Direct and sincere eye contact establishes immediate interpersonal rapport | El contacto visual directo y sincero establece una sintonía interpersonal inmediata
...
↔️ | Empathic perspective-taking dissolves deep inter-departmental divides | Adoptar una perspectiva empática disuelve profundas divisiones entre departamentos
