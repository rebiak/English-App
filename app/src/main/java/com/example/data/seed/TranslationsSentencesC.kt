...
object TranslationsSentencesC {
    ...
    private fun getListData(index: Int): String {
        return when (index) {
            1 -> """
❓ | What have you accomplished during this intensive training? | ¿Qué has logrado durante este entrenamiento intensivo?
...
✈️ | Where will you travel first to practice your spoken English? | ¿A dónde viajarás primero para practicar tu inglés hablado?
📚 | Mastery is not a destination, but a lifelong habit | El dominio no es un destino, sino un hábito para toda la vida
"""
            3 -> """
🗣️ | The instructor announced that all students had passed | El profesor anunció que todos los estudiantes habían aprobado
...
🌧️ | Even on difficult days, you kept moving forward | Incluso en los días difíciles, seguiste avanzando
...
"""
            8 -> """
✈️ | You are fully prepared to travel anywhere in the world | Estás totalmente preparado para viajar a cualquier parte del mundo
🧳 | Pack your bags and explore new cultures with confidence | Haz las maletas y explora nuevas culturas con seguridad
🏨 | Communicate effortlessly in hotels, restaurants and airports | Comunícate sin esfuerzo en hoteles, restaurantes y aeropuertos
🛏️ | Make lifelong friends wherever your travels take you | Haz amigos para toda la vida allá donde te lleven tus viajes
...
🛏️ | Reflect in English for five minutes before sleeping | Reflexiona en inglés durante cinco minutos antes de dormir
"""
            10 -> """
...
🌧️ | Rainy afternoons are perfect for reading English novels | Las tardes lluviosas son perfectas para leer novelas en inglés
⚡ | Let your enthusiasm ignite new language breakthroughs | Deja que tu entusiasmo encienda nuevos avances lingüísticos
❄️ | Winter evenings are ideal for cozy English study sessions | Las tardes de invierno son ideales para acogedoras sesiones de estudio
...
🛍️ | Treat yourself to a reward for completing these lists | Date una recompensa por completar estas listas
...
🍝 | Weave complex sentences together with total ease | Entrelaza oraciones complejas con total facilidad
...
🗣️ | Speak eloquently in debates, meetings and presentations | Habla con elocuencia en debates, reuniones y presentaciones
...
☁️ | Store your learnings and watch your confidence soar | Guarda tus aprendizajes y mira cómo despega tu seguridad
🖥️ | The digital frontier is entirely accessible to you | La frontera digital es enteramente accesible para ti
"""
            16 -> """
⚽ | You have scored the winning goal in your language training | Has marcado el gol de la victoria en tu entrenamiento de idioma
...
✈️ | Fly high and reach the pinnacle of your aspirations | Vuela alto y alcanza la cima de tus aspiraciones
"""
            21 -> """
📌 | Translating English sentences has become a piece of cake | Traducir oraciones en inglés se ha convertido en pan comido
🌧️ | Rain or shine, your English skills shine bright | Llueva o truene, tus habilidades en inglés brillan con fuerza
...
"""
            23 -> """
⚖️ | You have mastered the rules of English syntax | Has dominado las reglas de la sintaxis inglesa
...
👨‍⚖️ | Judge your progress by how much you have grown | Juzga tu progreso por cuánto has crecido
...
"""
            24 -> """
🔬 | The science of language acquisition proves that practice works | La ciencia de la adquisición de idiomas demuestra que la práctica funciona
...
🏛️ | Stand tall as a master of English sentence translation | Mantente firme como un maestro de la traducción de oraciones en inglés
...
"""
            28 -> """
🗣️ | Speak clearly, listen deeply, and communicate with love | Habla con claridad, escucha profundamente y comunícate con amor
