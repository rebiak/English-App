...
🛫 | Who will pick them up at the airport? | ¿Quien les recogerá en el aeropuerto?
...
1️⃣ | Because I'm the only one who knows how to do it | Por que soy el único que sabe hacerlo.
...
⚡ | Will he make a decision soon? | ¿Tomará una decisión pronto?
...
🧠 | I know I won't like it at all | Se que no me gustará en absoluto
...
📝 | Of course you can | Por supuesto que si
🗣️ | Can you speak a little louder? | ¿Puedes hablar un poco mas alto?
...
❓ | Who knows that besides you? | ¿Quien sabe eso además de ti?
...
❓ | I won't give them your name unless they ask me for it | No les daré tu nombre a no ser que me lo pidan
...
1️⃣ | This one's gold | Este es de oro
...
1️⃣ | What was your first reaction? | ¿Cuál fue tu primera reacción?
...
🍽️ | I ate it with my hands | Lo comí con las manos
...
🌧️ | It rained all night | Llovió toda la noche
...
1️⃣ | Who got here first? | ¿Quién llegó aquí primero?
...
1️⃣ | There were some problems at first | Hubo algunos problemas al principio
...
🏷️ | How much did it cost? | ¿Cuánto costó?
...
1️⃣ | That's a terrific idea. | Esa es una idea fabulosa.
...
1️⃣ | There will be an investigation | Habrá una investigación
...
🗣️ | I love listening to you talk | Me encanta escucharte hablar
...
1️⃣ | Didn't you have a chance? | ¿No tuviste una oportunidad?
...
🗣️ | I don't know what you're talking about. | No sé de qué estás hablando.
